...
export default function FacturaPage() {
  ...
  // Generar código de barras cuando el cliente carga
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#d1d5db', padding: '28px 12px', fontFamily: 'Arial, Helvetica, sans-serif' }}>

        {/* ══ DIV QUE SE CAPTURA COMO PDF — max 794px ancho ══ */}
        <div ref={invoiceRef} style={{ maxWidth: 794, margin: '0 auto', backgroundColor: '#ffffff', boxShadow: '0 8px 32px rgba(0,0,0,0.2)', overflow: 'hidden' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #0d1b3e 0%, #1a237e 55%, #0d47a1 100%)', padding: '22px 36px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                <img src="/logo12.png" alt="Medifibra" crossOrigin="anonymous"
              ...
              {/* Número factura + código de barras */}
